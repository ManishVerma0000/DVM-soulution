  ...
  return (
    <section className="bg-white py-16 px-4 text-center">
      ...
      <p className="mt-6 text-lg text-gray-600 max-w-3xl mx-auto">
        We design, build, and scale full-stack web and mobile applications with
        seamless <span className="font-medium">DevOps</span> integration. From
        robust backends to intuitive UIs, we ensure high performance,
